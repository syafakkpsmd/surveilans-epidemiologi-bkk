...
import { simpanIspaSaja } from '@/lib/supabase/queries-karhutla-client';
import { DAFTAR_WILAYAH_KARHUTLA } from '@/lib/karhutla/constants';

export default function HalamanFormIspaHarian() {
      ...
      <div className="w-full max-w-lg">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            BKK Kelas I Samarinda &middot; Surveilans Karhutla
          </p>
        </div>
