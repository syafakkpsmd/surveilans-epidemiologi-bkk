          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                disabled={isPending}
                className="w-full rounded-lg border border-black/10 px-3 py-2 pr-10 text-sm text-[#0F2A38] focus:outline-none focus:ring-2 focus:ring-[#0F4C5C] disabled:bg-gray-100"
                placeholder="••••••••"
              />
              <button
                type="button"
                ...
                disabled={isPending}
                tabIndex={-1}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#0F2A38]/50 hover:text-[#0F2A38] disabled:opacity-50"
                aria-label={tampilkanSandi ? 'Sembunyikan kata sandi' : 'Tampilkan kata sandi'}
              >
                {tampilkanSandi ? (
                  // Ikon mata dicoret (sandi sedang terlihat -> klik untuk sembunyikan)
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a18.5 18.5 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
                    <line x1="1" y1="1" x2="23" y2="23" />
                  </svg>
                ) : (
                  // Ikon mata terbuka (sandi tersembunyi -> klik untuk tampilkan)
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
