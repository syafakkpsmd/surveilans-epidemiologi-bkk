...
// Ambang batas ISPU "Tidak Sehat" untuk PM2.5 (acuan umum ~55 µg/m3 harian)
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      <h3 className="text-base font-semibold text-gray-900 mb-1">
        Kurva Epidemik: Kasus ISPA vs PM2.5
      </h3>
      <p className="text-xs text-gray-500 mb-3">
        Batang = jumlah kasus harian (sumbu kiri) &middot; Garis = rerata PM2.5 (sumbu kanan)
      </p>
